...
our $SCHEMA = [
    ...
    {begin_cat => ['Preferences', 'theme']},
      {begin_cat => ['Openbox', 'openbox']},
        ...
        {sep => undef},
        {item => ["subl3 ~/.config/openbox/menu.xml", 'Edit menu.xml', 'text-xml']},
        {item => ["subl3 ~/.config/openbox/rc.xml", 'Edit rc.xml', 'text-xml']},
        {item => ["subl3 ~/.config/openbox/autostart", 'Edit autostart', 'text-xml']},
        {sep => undef},
    ...
    {begin_cat => ['Menu Generator', 'menu-editor']},
      {item => ["subl3 ~/.config/obmenu-generator/schema.pl", 'Menu Layout', 'text-x-source']},
      {sep  => undef},
